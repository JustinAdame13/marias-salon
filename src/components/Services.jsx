    ...
    services: [
      {
        ...
        duration: '1 hr aprox.',
        includes: 'Solo mano de obra, no incluye producto',
      },
      {
    ...
    services: [
      {
        ...
        includes: 'Incluye masaje capilar',
      },
      {
      ...
      },
      {
        ...
        includes: 'Incluye prueba de estilo previa (agendar aparte)',
      },
      {
        ...
        includes: 'Incluye pestañas postizas sencillas',
      },
      {
    ...
    services: [
      {
        ...
        price: '$250',
        description: 'Cejas peinadas hacia arriba para un efecto voluminoso y prolijo.',
        duration: '40 min aprox.',
        includes: 'Incluye depilación con pinza',
      },
      {
        name: 'Henné de Ceja',
        price: '$200',
        description: 'Tinte semipermanente para definir y oscurecer la ceja.',
        duration: '30 min aprox.',
        includes: 'Dura entre 2–4 semanas',
      },
      {
        name: 'Henné + Laminado + Perfilación',
        price: '$350',
        description: 'Combo completo de tinte, laminado y perfilación en una sola cita.',
        duration: '1 hr aprox.',
        includes: 'Incluye depilación con pinza',
      },
      {
      ...
      },
      {
        ...
        price: '$400',
        description: 'Efecto de volumen mixto que combina densidad en las esquinas.',
        duration: '1.5–2 hrs aprox.',
        includes: 'Duración aprox. 3 semanas',
      },
      {
        ...
        price: '$550',
        description: 'Múltiples extensiones ultrafinas por pestaña natural para máximo volumen.',
        duration: '2–2.5 hrs aprox.',
  ...
  },
  {
    ...
    services: [
      ...
      },
      {
        name: 'Polygel',
        price: '$280',
        description: 'Alternativa ligera al acrílico, flexible y de apariencia natural.',
        duration: '1.5 hrs aprox.',
        includes: 'Incluye esmaltado semipermanente',
      },
      {
